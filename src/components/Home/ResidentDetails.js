...
const ResidentDetails = ({ residentsUrl }) => {
  ...
  return (
    <motion.div
      ...
      className='px-4 py-4 bg-gradient-to-r from-slate-200 to-stone-200 shadow-xl text-black rounded-lg md:p-10'
    >
      {resident ? (
        <div className='flex flex-col gap-y-3 '>
          <Typography className='font-poppins font-medium md:text-sm text-xs text-start flex items-center gap-2'>
            <Person />
